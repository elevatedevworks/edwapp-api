...
import { TEST_ACCOUNTS, TEST_USERS } from "../../helpers/fixtures";
import { deleteTestAccountsForUser, ensureTestAccount } from "../../helpers/accounts";
...
test("GET /finance/accounts returns only tha authenticated user's accounts", async() => {
    const app = await buildTestApp();
